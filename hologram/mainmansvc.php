...
<div class="container">
    ...
    <div class="contents">
        <div class="contents-inner" style="height: 2020px;">
		<!-- 내용-시작 -->
...
<iframe style="position:relative; left:0px; top:90px; width: 945px; height:240px;" src="subconfigureman.php" frameborder="0" scrolling="no"></iframe>
...
<label class="sub-title" style="position:absolute;left:32px; top:15px;" class="subtitle"><? echo $langRes["label"][3][$manLangCode] ?></label>
</div>
...
<label class="sub-title" style="position:absolute;left:32px; top:15px;" class="subtitle"><? echo $langRes["label"][4][$manLangCode] ?></label>
</div>
...
<label class="sub-title" style="position:absolute;left:32px; top:15px;" class="subtitle"><? echo $langRes["label"][5][$manLangCode] ?></label>
</div>
<iframe style="position:relative; left:0px; top:180px; width: 945px; height:380px;" src="subhologramman.php" frameborder="0" scrolling="no"></iframe>
...
<label class="sub-title" style="position:absolute;left:32px; top:15px;" class="subtitle"><? echo $langRes["label"][6][$manLangCode] ?></label>
</div>
