...
<image src="./image/add.png" style="position:relative; left:0px; top:15px; width: 49px; height:32px; cursor:pointer;" alt="추가" onclick="document.location.replace('subappaddform.php');"/>
...
echo '<th style="width:150px; cursor:pointer;" class="th2" onclick="document.location = \'subappman.php?appsrtattr=name&appsrtodr='.$odr.'\';">업데이트명'.$imghtml.'</th>';
...
echo '<th style="width:150px; cursor:pointer;" class="th2" onclick="document.location = \'subappman.php?appsrtattr=blddate&appsrtodr='.$odr.'\';">생성일'.$imghtml.'</th>';
...
echo '<th style="width:400px; cursor:pointer;" class="th2" onclick="document.location = \'subappman.php?appsrtattr=appdate&appsrtodr='.$odr.'\';">적용(예정)일'.$imghtml.'</th>';
...
echo '<th style="width:100px; cursor:pointer;" class="th2" onclick="document.location = \'subappman.php?appsrtattr=bldimg&appsrtodr='.$odr.'\';">이미지'.$imghtml.'</th>';
...
echo '<th style="width:100px; cursor:pointer;" class="th2" onclick="document.location = \'subappman.php?appsrtattr=state&appsrtodr='.$odr.'\';">상태'.$imghtml.'</th>';
?>
</tr>
<?php
