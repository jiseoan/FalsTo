...
<!--<image src="./image/update.png" style="position:absolute; left:100px; top:59px; width: 70px; height:32px; cursor:pointer;" alt="업데이트" onclick="updateClicked()"/>
-->
...
<th style="width:145px;" class="th1">언어</th>
<th style="width:800px;" class="th2">언어선택 버튼이미지</th>
</tr>
<?php
if ($ok) {
