Welcome to FalsTo! [![Build Status](https://travis-ci.org/adobe/brackets.svg?branch=master)](https://travis-ci.org/adobe/brackets)
-------------------
...
* **Do it yourself.** Because FalsTo is open source, and built with HTML, CSS, PHP
